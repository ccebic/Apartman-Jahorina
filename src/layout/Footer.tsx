import { FooterLink } from './components/NavLinks';
   ...
   return (
      <div className="footer bg-zinc-800">
         <div className="container mx-auto p-10">
            <div className="content flex flex-col justify-center align-middle text-center gap-7">
               ...
               <ul className="socials flex justify-center items-center gap-7">
                  <SocialIcon href="facebook link" icon={faFacebook} extraClasses="text-cyan-500" />
                  <SocialIcon href="facebook link" icon={faInstagram} extraClasses="text-cyan-500" />
                  <SocialIcon href="facebook link" text="B." extraClasses="text-[38px] text-cyan-500  font-bold relative top-[-3px]" />
               </ul>
            </div>
         </div>
         <div className="footer-down flex flex-col md:flex-row md:justify-between  justify-center py-3 px-2 bg-zinc-900 items-center text-white font-medium">
